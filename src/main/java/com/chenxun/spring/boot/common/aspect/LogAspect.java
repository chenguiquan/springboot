package com.chenxun.spring.boot.common.aspect;
...
public class LogAspect {
	...
	// Service层切点
	@Pointcut("@annotation(com.chenxun.spring.boot.common.annotation.ServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.chenxun.spring.boot.common.annotation.ControllerLog)")
