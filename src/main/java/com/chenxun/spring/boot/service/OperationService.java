...
import com.chenxun.spring.boot.common.pojo.MapperKey;
import com.chenxun.spring.boot.common.utils.AnnotationUtil;
import com.chenxun.spring.boot.common.utils.JsonConvertUtil;
...
public class OperationService extends AbstratService<AuthOperation> {
	// 扫描包
	private static final String PERMISS_PACKAGE = "com.chenxun.spring.boot.controller";
